...
<html>
	<head>
		...
		<script> 
			window.parent.document.title = 'Change Password'; 
			//scroll to down
			window.scrollTo(0,1); 
		</script>
	...
	<?php require('navbarS.php'); ?>
			...
			<div class="row">
				<div class="col-sm-8 offset-sm-2">
					<form action="" method="post" onsubmit="return false;">
						...
						<center><button type="submit" value="Login" class="sbutton" id="sbutton" >UPDATE</button><center>
					</form>
				</div>
			</div>
		...
		$("#sbutton").click(function(){
				...
				var cpass =$("#cp").val();
				if(oldpass!="" && newpass!=""){
					jQuery.post("http://localhost/student/changepasswordS.php" ,{oldpass: oldpass , newpass:newpass , cpass:cpass},function(text){
                        showsnack(text);
                    });
				}
				else{
